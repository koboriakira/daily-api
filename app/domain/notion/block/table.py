...
class Table(Block):
    ...
    def __init__(self, table_width: int, has_column_header: bool, has_row_header: bool, id: str, archived: bool, created_time: str, last_edited_time: str, has_children: bool,
                 parent: dict):
